...
public class ServiceProduit implements IService<Produit> {
    ...
    public void ajouter(Produit a) throws SQLException {
        try {
        PreparedStatement PS = con.prepareStatement("INSERT INTO `Produit` (`nom`, `prix`, `image`, `id_categorie`, `rating`) VALUES (?, ?, ?, ?, ? );");
    ...
    public void update(Produit t) throws SQLException {
        try {
            String requete = " update Produit set nom=? , prix=? , image=? ,id_categorie =?   where id='"+t.getId()+"'"  ;
            pst = con.prepareStatement(requete);
